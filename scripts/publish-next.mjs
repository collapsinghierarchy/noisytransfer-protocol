...
const order = [
  "errors","util","constants","crypto","transport",
  "noisystream","noisyauth","noisycache","noisytransfer-protocol"
];
...
for (const name of order) {
  ...
  console.log(`\n— ${name} —`);
  const dry = spawnSync(npmCmd, ["publish","--access","public","--tag","next","--dry-run"], { cwd, stdio: "inherit" });
